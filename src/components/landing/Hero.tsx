    ...
    <section className="relative min-h-[90vh] flex items-center justify-center pt-14 overflow-hidden bg-foreground">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 py-16">
        <div className="flex flex-col items-start gap-8">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-sysde-green/20 border border-[hsl(var(--sysde-green))]/30 rounded-full px-4 py-1.5 text-sm font-semibold text-[hsl(var(--sysde-green-foreground))]">
          ...
          <p className="text-background/50 text-base md:text-lg max-w-xl leading-relaxed">
            {t.hero.subtitle}
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-full mt-4">
            {stats.map((stat, i) => (
              <div key={i} ref={stat.ref} className="bg-background/5 border border-background/10 rounded-xl p-5 text-center">
