...
const labels: Record<Lang, Record<string, string>> = {
  ...
  fr: {
    ...
    cronogramaLicenses: "Licences d'utilisation — Tarif préférentiel 1 300 USD par licence — PacLicence illimitéeel et réglementaire. Rapports dLicence illimitée"Migration de la base de données centralisatrice vers SAF UPV 7.0",
