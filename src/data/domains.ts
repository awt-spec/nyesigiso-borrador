...
export const domains: Domain[] = [
  ...
  // ===== DOMINIO 02 - MULTICANAL =====
  {
    ...
    items: [
      ...
      { es: "Internet Banking", fr: "Internet Banking", en: "Internet Banking", group: "banca-distancia", status: "no-cubierto", scope: { es: "NO incluido en propuesta - Módulo separado requiere cotización adicional.", fr: "NON inclus dans la proposition - Module séparé nécessite un devis additionnel.", en: "NOT included in proposal - Separate module requires additional quote." } },
      { es: "Banca Móvil", fr: "Mobile Banking", en: "Mobile Banking", group: "banca-distancia", status: "no-cubierto", scope: { es: "NO incluido en propuesta - Módulo separado requiere cotización adicional.", fr: "NON inclus dans la proposition - Module séparé nécessite un devis additionnel.", en: "NOT included in proposal - Separate module requires additional quote." } },
      { es: "SMS / Alertas", fr: "SMS / Alertes", en: "SMS / Alerts", group: "banca-distancia", status: "no-cubierto", scope: { es: "NO incluido en propuesta - Módulo separado requiere cotización adicional.", fr: "NON inclus dans la proposition - Module séparé nécessite un devis additionnel.", en: "NOT included in proposal - Separate module requires additional quote." } },
    ],
  },
  // ===== DOMINIO 03 - MARKETING Y COMERCIAL =====
  {
    ...
    items: [
      { es: "Archivo de Prospectos", fr: "Fichier prospects", en: "Prospect File", group: "marketing", status: "no-cubierto", scope: { es: "NO incluido - Funcionalidad CRM separada requiere cotización.", fr: "NON inclus - Fonctionnalité CRM séparée nécessite un devis.", en: "NOT included - Separate CRM functionality requires quote." } },
      ...
      { es: "Carteras Comerciales", fr: "Portefeuilles commerciaux", en: "Commercial Portfolios", group: "comercial", status: "no-cubierto", scope: { es: "NO incluido - Módulo CRM separado requiere cotización.", fr: "NON inclus - Module CRM séparé nécessite un devis.", en: "NOT included - Separate CRM module requires quote." } },
      { es: "Gestión de Eventos", fr: "Gestion événementielle", en: "Event Management", group: "comercial", status: "no-cubierto", scope: { es: "NO incluido en propuesta.", fr: "NON inclus dans la proposition.", en: "NOT included in proposal." } },
      { es: "Seguimiento de Actividad del Asesor", fr: "Suivi d'activité du conseiller", en: "Advisor Activity Tracking", group: "comercial", status: "no-cubierto", scope: { es: "NO incluido - Módulo CRM separado requiere cotización.", fr: "NON inclus - Module CRM séparé nécessite un devis.", en: "NOT included - Separate CRM module requires quote." } },
    ],
  },
  ...
  // ===== DOMINIO 05 - GESTION DE CLIENTES =====
  {
    ...
    items: [
      ...
      { es: "Garantías", fr: "Garanties", en: "Guarantees", group: "riesgos", status: "no-cubierto", scope: { es: "NO incluido - Módulo Gestión Garantías separado requiere cotización.", fr: "NON inclus - Module Gestion des Garanties séparé nécessite un devis.", en: "NOT included - Separate Guarantee Management module requires quote." } },
      ...
      { es: "Calificación/Scoring", fr: "Cotation", en: "Scoring/Rating", group: "riesgos", status: "no-cubierto", scope: { es: "NO incluido - Módulo Credit Scoring separado requiere cotización.", fr: "NON inclus - Module Credit Scoring séparé nécessite un devis.", en: "NOT included - Separate Credit Scoring module requires quote." } },
      { es: "Contencioso", fr: "Contentieux", en: "Litigation", group: "juridico", status: "no-cubierto", scope: { es: "NO incluido - Módulo Gestión Contencioso separado requiere cotización.", fr: "NON inclus - Module Gestion Contentieux séparé nécessite un devis.", en: "NOT included - Separate Litigation Management module requires quote." } },
      { es: "Sucesiones", fr: "Successions", en: "Successions", group: "juridico", status: "no-cubierto", scope: { es: "NO incluido en propuesta.", fr: "NON inclus dans la proposition.", en: "NOT included in proposal." } },
      { es: "Embargos, Notificación a Terceros", fr: "Saisie arrêt, Avis à tiers détenteur", en: "Seizures, Third-Party Notices", group: "juridico", status: "no-cubierto", scope: { es: "NO incluido - Módulo ATD separado requiere cotización.", fr: "NON inclus - Module ATD séparé nécessite un devis.", en: "NOT included - Separate ATD module requires quote." } },
      { es: "Reclamaciones", fr: "Réclamations", en: "Claims", group: "juridico", status: "no-cubierto", scope: { es: "NO incluido en propuesta.", fr: "NON inclus dans la proposition.", en: "NOT included in proposal." } },
    ],
  },
  // ===== DOMINIO 06 - PRODUCTOS Y SERVICIOS =====
  {
    ...
    items: [
      ...
      { es: "Avales/Fianzas", fr: "Cautions", en: "Sureties/Guarantees", group: "creditos", status: "parcial", scope: { es: "Funcionalidad básica, gestión avanzada no incluida.", fr: "Fonctionnalité de base, gestion avancée non incluse.", en: "Basic functionality, advanced management not included." } },
      { es: "Compromiso por Firma", fr: "Engagement par signature", en: "Signature Commitment", group: "creditos", status: "parcial", scope: { es: "Funcionalidad básica disponible.", fr: "Fonctionnalité de base disponible.", en: "Basic functionality available." } },
      ...
      { es: "Parametrización de Productos", fr: "Paramétrage des produits", en: "Product Parameterization", group: "catalogo", status: "excluido", scope: { es: "EXCLUIDO Art. 6: Módulos de parametrización NO incluidos en proceso de consolidación.", fr: "EXCLU Art. 6 : Modules de paramétrage NON inclus dans le processus de consolidation.", en: "EXCLUDED Art. 6: Parameterization modules NOT included in consolidation process." } },
      { es: "Creación de Nuevos Productos", fr: "Création de nouveaux produits", en: "New Product Creation", group: "catalogo", status: "excluido", scope: { es: "EXCLUIDO Art. 6: Módulos de parametrización NO incluidos en proceso de consolidación.", fr: "EXCLU Art. 6 : Modules de paramétrage NON inclus dans le processus de consolidation.", en: "EXCLUDED Art. 6: Parameterization modules NOT included in consolidation process." } },
    ],
  },
  ...
  // ===== DOMINIO 08 - FUNCIONES DE SOPORTE =====
  {
    ...
    items: [
      ...
      { es: "Activos Fijos", fr: "Immobilisations", en: "Fixed Assets", group: "contabilidad", status: "no-cubierto", scope: { es: "NO incluido - Módulo Inmobilizaciones separado requiere cotización.", fr: "NON inclus - Module Immobilisations séparé nécessite un devis.", en: "NOT included - Separate Fixed Assets module requires quote." } },
      { es: "Conciliación", fr: "Lettrage", en: "Reconciliation", group: "contabilidad", status: "no-cubierto", scope: { es: "NO incluido - Módulo separado requiere cotización.", fr: "NON inclus - Module séparé nécessite un devis.", en: "NOT included - Separate module requires quote." } },
      { es: "Compras - Inventarios", fr: "Achats - Stocks", en: "Purchases - Inventory", group: "contabilidad", status: "no-cubierto", scope: { es: "NO incluido - Módulo ERP separado requiere cotización.", fr: "NON inclus - Module ERP séparé nécessite un devis.", en: "NOT included - Separate ERP module requires quote." } },
      ...
      { es: "Nómina", fr: "Paie", en: "Payroll", group: "rrhh", status: "no-cubierto", scope: { es: "NO incluido - Módulo RRHH/Paie separado requiere cotización.", fr: "NON inclus - Module RH/Paie séparé nécessite un devis.", en: "NOT included - Separate HR/Payroll module requires quote." } },
      { es: "Gestión del Personal", fr: "Gestion du personnel", en: "Staff Management", group: "rrhh", status: "no-cubierto", scope: { es: "Formación, promoción, reclutamiento. NO incluido - Módulo RRHH separado requiere cotización.", fr: "Formation, promotion, recrutement. NON inclus - Module RH séparé nécessite un devis.", en: "Training, promotion, recruitment. NOT included - Separate HR module requires quote." } },
      ...
      { es: "Autorizaciones/Permisos", fr: "Habilitations", en: "Authorizations/Permissions", group: "control", status: "excluido", scope: { es: "EXCLUIDO Art. 6: Módulos de SEGURIDAD NO incluidos en proceso de consolidación.", fr: "EXCLU Art. 6 : Modules de SÉCURITÉ NON inclus dans le processus de consolidation.", en: "EXCLUDED Art. 6: SECURITY modules NOT included in consolidation process." } },
      { es: "Delegaciones", fr: "Délégations", en: "Delegations", group: "control", status: "excluido", scope: { es: "EXCLUIDO Art. 6: Módulos de SEGURIDAD NO incluidos en proceso de consolidación.", fr: "EXCLU Art. 6 : Modules de SÉCURITÉ NON inclus dans le processus de consolidation.", en: "EXCLUDED Art. 6: SECURITY modules NOT included in consolidation process." } },
      { es: "Inspección", fr: "Inspection", en: "Inspection", group: "control", status: "no-cubierto", scope: { es: "NO incluido en propuesta.", fr: "NON inclus dans la proposition.", en: "NOT included in proposal." } },
      { es: "Control y Trazabilidad", fr: "Contrôle & traçabilité", en: "Control & Traceability", group: "control", status: "excluido", scope: { es: "EXCLUIDO Art. 6: Módulos de SEGURIDAD NO incluidos en proceso de consolidación.", fr: "EXCLU Art. 6 : Modules de SÉCURITÉ NON inclus dans le processus de consolidation.", en: "EXCLUDED Art. 6: SECURITY modules NOT included in consolidation process." } },
      ...
      { es: "Proveedores", fr: "Fournisseurs", en: "Suppliers", group: "finanzas", status: "no-cubierto", scope: { es: "NO incluido - Módulo ERP separado requiere cotización.", fr: "NON inclus - Module ERP séparé nécessite un devis.", en: "NOT included - Separate ERP module requires quote." } },
      ...
      { es: "Obras y Proyectos", fr: "Chantiers & projets", en: "Projects & Works", group: "logistica", status: "no-cubierto", scope: { es: "NO incluido - Módulo ERP separado requiere cotización.", fr: "NON inclus - Module ERP séparé nécessite un devis.", en: "NOT included - Separate ERP module requires quote." } },
      { es: "Archivo", fr: "Archivage", en: "Archiving", group: "logistica", status: "no-cubierto", scope: { es: "NO incluido - Módulo GED separado requiere cotización.", fr: "NON inclus - Module GED séparé nécessite un devis.", en: "NOT included - Separate DMS module requires quote." } },
    ],
  },
  // ===== DOMINIO 09 - PILOTAJE Y DECISION =====
  {
    ...
    items: [
      ...
      { es: "Contabilidad Analítica", fr: "Comptabilité analytique", en: "Analytical Accounting", group: "pilotaje", status: "no-cubierto", scope: { es: "NO incluido - Módulo BI separado requiere cotización.", fr: "NON inclus - Module BI séparé nécessite un devis.", en: "NOT included - Separate BI module requires quote." } },
      { es: "Presupuesto", fr: "Budget", en: "Budget", group: "pilotaje", status: "no-cubierto", scope: { es: "NO incluido - Módulo ERP separado requiere cotización.", fr: "NON inclus - Module ERP séparé nécessite un devis.", en: "NOT included - Separate ERP module requires quote." } },
      ...
      { es: "DataWarehouse", fr: "DataWarehouse", en: "DataWarehouse", group: "decision", status: "no-cubierto", scope: { es: "NO incluido - Módulo BI separado requiere cotización.", fr: "NON inclus - Module BI séparé nécessite un devis.", en: "NOT included - Separate BI module requires quote." } },
      { es: "Herramientas de Apoyo a la Decisión (BI)", fr: "Outils d'aide à la décision", en: "Decision Support Tools (BI)", group: "decision", status: "no-cubierto", scope: { es: "NO incluido - Módulo BI separado requiere cotización.", fr: "NON inclus - Module BI séparé nécessite un devis.", en: "NOT included - Separate BI module requires quote." } },
    ],
  },
  // ===== DOMINIO 10 - INTERCAMBIOS INTERNOS =====
  {
    ...
    items: [
      { es: "Workflow", fr: "Workflow", en: "Workflow", status: "no-cubierto", scope: { es: "NO incluido - Módulo Workflow separado requiere cotización.", fr: "NON inclus - Module Workflow séparé nécessite un devis.", en: "NOT included - Separate Workflow module requires quote." } },
      { es: "Gestión Electrónica de Documentos (GED)", fr: "Gestion électronique de documents", en: "Electronic Document Management (EDM)", status: "no-cubierto", scope: { es: "NO incluido - Módulo GED separado requiere cotización.", fr: "NON inclus - Module GED séparé nécessite un devis.", en: "NOT included - Separate DMS module requires quote." } },
      { es: "Web Services", fr: "Web Services", en: "Web Services", status: "no-cubierto", scope: { es: "NO incluido - Módulo APIs separado requiere cotización.", fr: "NON inclus - Module APIs séparé nécessite un devis.", en: "NOT included - Separate APIs module requires quote." } },
      { es: "APIs", fr: "APIs", en: "APIs", status: "no-cubierto", scope: { es: "NO incluido - Módulo APIs separado requiere cotización.", fr: "NON inclus - Module APIs séparé nécessite un devis.", en: "NOT included - Separate APIs module requires quote." } },
    ],
  },
