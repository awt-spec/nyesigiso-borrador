...
const labels: Record<Lang, Record<string, string>> = {
  es: {
    ...
    cronogramaLicenses: "Licencias de utilización — Licencia ilimitada y reglamentario. Informes BCEAO y operaciones de Nyèsigiso",
  ...
  fr: {
    ...
    cronogramaLicenses: "Licences d'utilisation — Tarif préférentiel 1 300 USD par licence — PacLicence illimitéeel et réglementaire. Rapports de la BCEAO et opérations de Nyèsigiso",
