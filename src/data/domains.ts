...
export const domains: Domain[] = [
  ...
  // ===== DOMINIO 10 - INTERCAMBIOS INTERNOS =====
  {
    ...
    items: [
      ...
      { es: "Web Services", fr: "Web Services", en: "Web Services", status: "cubierto", included: true, scope: { es: "Incluido — Conectividad con STRATEGO, Orange Money, BCEAO y otros servicios externos.", fr: "Inclus — Connectivité avec STRATEGO, Orange Money, BCEAO et autres services externes.", en: "Included — Connectivity with STRATEGO, Orange Money, BCEAO and other external services." } },
      { es: "APIs", fr: "APIs", en: "APIs", status: "cubierto", included: true, scope: { es: "Incluido — APIs REST integradas con Web Services.", fr: "Inclus — APIs REST intégrées avec Web Services.", en: "Included — REST APIs bundled with Web Services." } },
    ],
  },
